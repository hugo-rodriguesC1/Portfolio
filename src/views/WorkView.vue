<template>
  ...
  <div>
      <div class="flex items-center text-[#154d13] uppercase gap-10 leading-none mt-10">
        <h2 class="text-[8.5rem]">Ecarvtc</h2>
        <div class="text-2xl">
      ...
      <div class="flex items-center text-[#154d13] uppercase gap-10 leading-none">
        <div class="text-2xl">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur fringilla nunc quis gravida feugiat. Cras commodo suscipit leo a
          lobortis. Fusce ultricies metus et turpis tempus, et tincidunt nisi hendrerit.
        </div>
