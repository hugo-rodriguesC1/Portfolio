...
<template>
  <div class="flex flex-col items-center">
    ...
    <h1 class="self-start text-[3.5rem] sm:text-[4rem] md:text-[4.5rem] lg:text-[5rem] xl:text-[7rem]  3xl:text-[8.5rem] uppercase leading-none text-[#154d13] mt-5">EcarVTC</h1>
